    ...
    (t.prototype = {
      ...
      showResult: function (t) {
        -1 === t
          ...
          : (0 === t
              ? this.$archiveResult.html(this.messages.zero)
              : 1 === t
              ? this.$archiveResult.html(this.messages.one)
              : this.$archiveResult.html(
                  this.messages.other.replace(/\{n\}/, t)
                )
            ).show();
      },
  ...
  (function (o) {
    ...
    (t.prototype = {
      ...
      showPosts: function (t) {
        ...
        0 < s.countCategories(t) &&
          o(e + "[data-" + s.dataParentCategories + "]").length &&
          o(e).each(function () {
            o(this)
              .attr("data-" + s.dataParentCategories)
              .split(",")
              .forEach(function (t) {
                t = "[data-" + s.dataCategory + "='" + t + "']";
                o(s.categories + t).show(),
                  o(s.posts + t).show(),
                  o(s.posts + t + " > .archive-posts > .archive-post").hide();
              });
          }),
          o(e).show(),
          o(i).show(),
  ...
  (function (e) {
    ...
    (t.prototype = {
      ...
      swipePostBottomBar: function () {
        ...
        this.lastScrollTop > t &&
          Math.abs(this.lastScrollDownPos - t) > this.delta &&
          (s + this.$postFooter.height() > t + e(window).height() ||
            s < t + this.$header.height()) &&
          (this.$postBottomBar.slideDown(), (this.lastScrollUpPos = t)),
          t > this.lastScrollUpPos + this.delta &&
            (this.$postBottomBar.slideUp(), (this.lastScrollDownPos = t)),
          (this.lastScrollTop = t);
      },
    }),
      e(document).ready(function () {
  ...
  (function (t) {
    ...
    function s() {
      (this.$sidebar = t("#sidebar")),
        ...
        (this.$closeBtn = t("#header, #main, .post-header-cover")),
        ...
        (this.$blog = t(
          ...
          .add(this.$header)
          .add(this.$headerElements.title)
          .add(this.$headerElements.rightPicture)),
        (this.$body = t("body")),
    ...
    (s.prototype = {
      run: function () {
        ...
        t(document)
          .on("touchstart", function (t) {
            e.$sidebar.hasClass("pushed") &&
              ((t = (t.touches || t.originalEvent.touches)[0]),
              (i = t.clientX),
              (o = t.clientY));
          })
          .on("touchmove", function (t) {
            ...
            i &&
              ...
              (s = i - s),
              (t = o - t),
              Math.abs(s) > Math.abs(t) && 0 < s && e.closeSidebar(),
              (o = i = null));
          }),
          t(window).resize(function () {
            t(window).width() > e.mediumScreenWidth
              ? (e.resetSidebarPosition(), e.resetBlogPosition())
              : e.closeSidebar();
          });
      },
      ...
      swipeBlogToRight: function () {
        ...
        (t =
          this.$header.width() -
            this.$sidebar.width() -
            this.$headerElements.titleLink.width() <
          130
            ? t
                .not(this.$headerElements.title)
                .not(this.$headerElements.rightPicture)
            : t).hasClass("pushed") ||
          t.hasClass("processing") ||
          (t.addClass("processing pushed"),
          setTimeout(function () {
